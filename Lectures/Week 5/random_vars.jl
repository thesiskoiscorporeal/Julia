...
# ╔═╡ ca06f4d0-8afb-11eb-0d88-972f81ec6021
@bind toss_num Slider(1:100000)

# ╔═╡ 8fe715e4-8727-11eb-2e7f-15b723bb8d9d
tosses = rand( ["head", "tail"], toss_num)
...
md"""
dof = $(@bind dof Slider(1:1000, show_value=true))  
"""

# ╔═╡ e01b6f70-873c-11eb-04a1-ad8e86578982
chisq_data = rand( Arcsine(dof), 100000 )
...
# ╔═╡ b2075d20-8b00-11eb-13ee-6f160ca7df1c
md"""
### The central limit theorem really works !
"""

# ╔═╡ da62fd1c-873c-11eb-0758-e7cb48e964f1
histogram( [ sum( randn() for _=1:dof )  for _ = 1:100000], norm=true,
	alpha=0.5, leg=false)
